...
#Constructing a function: To convert Petal.Width into an index, I will have to divide each Petal.Width value by its mean where the mean = 1 post transformation. This is what the function 'data' will achieve.

data <- function(x) {x/mean(x)}

#Applying function to our data subset
iris_by_petalwidth$Petal.Width <- data(iris_by_petalwidth$Petal.Width)

#Double-checking if the transformation has worked. If so, the mean should be equal to 1
